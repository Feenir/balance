<?php
/**
 * Главная страница (page-pay.php)
 * @package WordPress
 * @subpackage balanse
 * Template Name: Страница оплаты
 */
get_header();
// live_v_LJbuN37hPOCLzhUbhPqVNl46-abtVaxt6jBNTGyqc
?>

    <br><link rel="stylesheet" href="https://yookassa.ru/integration/simplepay/css/yookassa_construct_form.css">
    <form class="pay-form yoomoney-payment-form" action="https://yookassa.ru/integration/simplepay/payment" method="post" accept-charset="utf-8" >

        <div class="pay-form__wrapper ym-customer-info">
            <div class="pages-additional title_color">Оплата услуг</div>
            <input name="custName" class="pay-form__item pay-form__item_input ym-input" placeholder="ФИО" type="text" value="" required>
            <input name="cps_email" class="pay-form__item pay-form__item_input ym-input" placeholder="Email" type="text" value="" required>
            <input name="cps_phone" class="pay-form__item pay-form__item_input ym-input js-phoneMask" placeholder="Телефон" type="text" value="" required>
            <textarea class="pay-form__item pay-form__item_textarea ym-textarea" name="orderDetails" placeholder="Назначение платежа" value=""></textarea>
        </div>
...
<!--            <lineargradient id="paint1_linear" x1="12.8472" y1="9.35889" x2="12.8472" y2="55.2393" gradientunits="userSpaceOnUse"><stop stop-color="#0160D1"><stop offset="1" stop-color="#00479C"></stop></stop></lineargradient>-->
        ...
        <input name="shopId" type="hidden" value="882348"></form> <?php // только это поле поменялось при переходе с теста на боевой?>
...
<?php /*
    ...
    <script>
        ...
        const checkout = new window.YooMoneyCheckoutWidget({
            confirmation_token: 'live_v_LJbuN37hPOCLzhUbhPqVNl46-abtVaxt6jBNTGyqc', //Токен, который перед проведением оплаты нужно получить от ЮKassa
            return_url: 'https://balanse-expert.ru', //Ссылка на страницу завершения оплаты
